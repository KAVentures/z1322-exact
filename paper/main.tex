...
The source archive includes an explicit $137$-edge witness, all certificates, the exhaustive enumerator, independent profile enumerators, and a one-command verification gate. The result should nevertheless be regarded as a new computer-assisted proof pending independent reproduction and peer review.
...
A systematic literature and repository search conducted on 27 July 2026 located the $137$-edge lower bound and the previously recorded upper bound $140$, but no prior exact determination of $\Z(13,22,3,3)$. This priority statement is necessarily provisional and should be rechecked during peer review.
